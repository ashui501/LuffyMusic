...
from LuffyMusic import Telegram, YouTube, app
from LuffyMusic.misc import SUDOERS, _boot_
from LuffyMusic.plugins.playlist import del_plist_msg
from LuffyMusic.plugins.sudoers import sudoers_list
from LuffyMusic.utils.database import (add_served_chat,
                                       add_served_user,
                                       get_served_chats,
                                       get_served_users,
                                       blacklisted_chats,
...
from LuffyMusic.utils.decorators.language import LanguageStart
from LuffyMusic.utils.formatters import get_readable_time
from LuffyMusic.utils.inline import (help_pannel, private_panel,
                                     start_pannel)
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/The_Apexx) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
            ...
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="• sᴜᴩᴩᴏʀᴛ •", url="https://t.me/The_Apexx"
                        ),
                    ],
                ]
            )
