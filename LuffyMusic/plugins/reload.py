...
from LuffyMusic.utils.database import get_authuser_names, get_cmode
from LuffyMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from LuffyMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Luffy.stop_stream(message.chat.id)
    except:
        pass
